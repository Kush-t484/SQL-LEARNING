...
CASE WHEN quantity>=10 THEN 'Instock'
WHEN quantity BETWEEN 6 AND 9 THEN 'Limited Stock'
ELSE 'Out of Stock soon' END AS quantity_available
FROM products;
...
ELSE 'Accessories Item' END AS Category_type FROM products;